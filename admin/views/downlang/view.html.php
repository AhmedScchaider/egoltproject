...
class EgoltProjectViewDownlang extends JView
{
	...
	protected function addToolBar() 
	{
		...
		$egolt_title_suffix = JText::_( 'COM_EGOLTPROJECT_DOWNLANGS' ) . ' : ' . $suffix1 ;
		...
		JToolBarHelper::save('downlang.save');
		JToolBarHelper::cancel('downlang.cancel', $isNew ? 'JTOOLBAR_CANCEL'
		                                                   : 'JTOOLBAR_CLOSE');
	}
}
