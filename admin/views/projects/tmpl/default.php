...
<form action="<?php echo JRoute::_('index.php?option=com_egoltproject&view=projects'); ?>" method="post" name="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="25%">
					<?php echo JHtml::_('grid.sort',  'JGLOBAL_TITLE', 'lang.title', $listDirn, $listOrder); ?>
				</th>
				<th>
					<?php echo JHtml::_('grid.sort',  'COM_EGOLTPROJECT_INTRO', 'lang.intro', $listDirn, $listOrder); ?>
				</th>
				<th width="15%">
				...
				<th width="5%">
					<?php echo JHtml::_('grid.sort',  'COM_EGOLTPROJECT_JED', 'general.jed', $listDirn, $listOrder); ?>
				</th>
				<th width="1%" class="nowrap">
					<?php echo JHtml::_('grid.sort',  'COM_EGOLTPROJECT_ID', 'lang.project_id', $listDirn, $listOrder); ?>
				</th>
			</tr>
		</thead>
		<tfoot>
		...
		<?php foreach ($this->items as $i => $item): ?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_egoltproject&task=project.edit&id='.(int) $item->project_id. '&elang='. $item->lang_code); ?>">
				...
				<td>
					<?php echo substr(strip_tags($item->intro),0,200) . ' ...'; ?>
				</td>
				<td align="center">
				<?php foreach($this->langs as $i => $languages): ?>
					...
					?>
					<a href="<?php echo JRoute::_('index.php?option=com_egoltproject&task=project.edit&id='. $item->project_id . '&elang=' . $languages->lang_code); ?>">
				...
				<td align="center">
					<?php if($item->jed): ?>
					<a href="<?php echo $item->jed; ?>" target="_blank" ><img src="components/com_egoltproject/assets/images/joomla.png" /></a>
					<?php endif; ?>
				</td>
				<td class="center">
