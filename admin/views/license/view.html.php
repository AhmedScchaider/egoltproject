...
class EgoltProjectViewLicense extends JView
{
	...
	protected function addToolBar() 
	{
		...
		$egolt_title_suffix = JText::_( 'COM_EGOLTPROJECT_LICENSES' ) . ' : ' . $suffix1 ;
		...
		JToolBarHelper::cancel('license.cancel', $isNew ? 'JTOOLBAR_CANCEL'
		                                                   : 'JTOOLBAR_CLOSE');
	}
}
