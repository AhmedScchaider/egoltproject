...
?>
<form action="<?php echo JRoute::_('index.php?option=com_egoltproject&view=license&layout=edit&id=' .  JRequest::getVar('id') ); ?>"
	...
	<div>
		<input type="hidden" name="task" value="license.edit" />
